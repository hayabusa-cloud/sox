...
func (ur *ioUring) nop(ctx context.Context, flags uint8, fd int) error {
	return ur.submit3(contextWithFD(ctx, fd), IORING_OP_NOP, flags, fd, 0, 0)
}
...
func (ur *ioUring) readv(ctx context.Context, flags uint8, fd int, iov [][]byte) error {
	...
	return ur.submit6(contextWithFD(ctx, fd), opcode, flags, fd, 0, uint64(addr), n, unix.MSG_WAITALL)
}
...
func (ur *ioUring) writev(ctx context.Context, flags uint8, fd int, iov [][]byte) error {
	...
	return ur.submit3(contextWithFD(ctx, fd), opcode, flags, fd, uint64(addr), n)
}

func (ur *ioUring) fsync(ctx context.Context, flags uint8, fd int) error {
	return ur.submit3(contextWithFD(ctx, fd), IORING_OP_FSYNC, flags, fd, 0, 0)
}
...
func (ur *ioUring) readFixed(ctx context.Context, flags uint8, fd int, i int) (buf []byte, err error) {
	...
	return ur.bufs[i], ur.submit9(contextWithFD(ctx, fd), opcode, flags, fd, 0, addr, len(ur.bufs[i]), unix.MSG_WAITALL, uint16(i), 0, 0)
}
...
func (ur *ioUring) writeFixed(ctx context.Context, flags uint8, fd int, i int, n int) error {
	...
	return ur.submit9(contextWithFD(ctx, fd), opcode, flags, fd, 0, addr, n, 0, uint16(i), 0, 0)
}

func (ur *ioUring) pollAdd(ctx context.Context, flags uint8, fd int, how int, events int) error {
	return ur.submit6(ctx, IORING_OP_POLL_ADD, flags, fd, 0, 0, how, uint32(events))
}

func (ur *ioUring) pollRemove(ctx context.Context, flags uint8) error {
	return ur.submit3(ctx, IORING_OP_POLL_REMOVE, flags, 0, 0, 0)
}

func (ur *ioUring) syncFileRange(ctx context.Context, flags uint8, fd int, off int64, n int, uflags int) error {
	return ur.submit6(ctx, IORING_OP_SYNC_FILE_RANGE, flags, fd, uint64(off), 0, n, uint32(uflags))
}

func (ur *ioUring) sendmsg(ctx context.Context, flags uint8, fd int, buffers [][]byte, oob []byte, to unix.Sockaddr) error {
	...
	return ur.submit6(contextWithFD(ctx, fd), opcode, flags, fd, 0, uint64(addr), 1, 0)
}

func (ur *ioUring) recvmsg(ctx context.Context, flags uint8, fd int, buffers [][]byte, oob []byte) error {
	...
	return ur.submit6(contextWithFD(ctx, fd), opcode, flags, fd, 0, uint64(addr), 1, unix.MSG_WAITALL)
}
...
func (ur *ioUring) timeout(ctx context.Context, flags uint8, cnt int, ts *unix.Timespec, uflags int) error {
	...
	return ur.submit6(ctx, IORING_OP_TIMEOUT, flags, 0, uint64(cnt), addr, 1, uint32(uflags))
}
...
func (ur *ioUring) timeoutUpdate(ctx context.Context, flags uint8, userData unsafe.Pointer, ts *unix.Timespec, uflags int) error {
	...
	return ur.submit6(ctx, IORING_OP_TIMEOUT_REMOVE, flags, 0, addr2, addr, 0, uint32(uflags|IORING_TIMEOUT_UPDATE))
}

func (ur *ioUring) timeoutRemove(ctx context.Context, flags uint8, userData unsafe.Pointer, uflags int) error {
	addr := uint64(uintptr(userData))
	return ur.submit6(ctx, IORING_OP_TIMEOUT_REMOVE, flags, 0, 0, addr, 0, uint32(uflags))
}

func (ur *ioUring) accept(ctx context.Context, flags uint8, fd int) error {
	return ur.submit6(contextWithFD(ctx, fd), IORING_OP_ACCEPT, flags, fd, 0, 0, 0, unix.SOCK_NONBLOCK|unix.SOCK_CLOEXEC)
}
...
func (ur *ioUring) asyncCancel(ctx context.Context, flags uint8, userdata *ioUringCtx) error {
	...
	return ur.submit3(ctx, IORING_OP_ASYNC_CANCEL, flags, 0, addr, 0)
}

func (ur *ioUring) linkTimeout(ctx context.Context, flags uint8, ts *unix.Timespec, uflags int) error {
	addr := uint64(uintptr(unsafe.Pointer(ts)))
	return ur.submit6(ctx, IORING_OP_LINK_TIMEOUT, flags, 0, 0, addr, 1, uint32(uflags))
}
...
func (ur *ioUring) connect(ctx context.Context, flags uint8, fd int, sa unix.Sockaddr) error {
	...
	return ur.submit6(contextWithFD(ctx, fd), IORING_OP_CONNECT, flags, fd, uint64(n), uint64(uintptr(ptr)), 0, 0)
}

func (ur *ioUring) fAllocate(ctx context.Context, flags uint8, fd int, mode uint32, off int64, len int64) error {
	return ur.submit6(contextWithFD(ctx, fd), IORING_OP_FALLOCATE, flags, fd, uint64(off), uint64(len), int(mode), 0)
}
...
func (ur *ioUring) openAt(ctx context.Context, flags uint8, dirfd int, pathname string, uflags int, mode uint32) error {
	...
	return ur.submit6(contextWithFD(ctx, dirfd), IORING_OP_OPENAT, flags, dirfd, 0, addr, int(mode), uint32(uflags|unix.O_LARGEFILE))
}

func (ur *ioUring) close(ctx context.Context, flags uint8, fd int) error {
	return ur.submit3(contextWithFD(ctx, fd), IORING_OP_CLOSE, flags, fd, 0, 0)
}
...
func (ur *ioUring) statx(ctx context.Context, flags uint8, dirfd int, path string, uflags int, mask int, stat *unix.Statx_t) error {
	...
	return ur.submit6(contextWithFD(ctx, dirfd), IORING_OP_STATX, flags, dirfd, off, addr, mask, uint32(uflags))
}
...
func (ur *ioUring) read(ctx context.Context, flags uint8, fd int, p []byte) error {
	...
	return ur.submit3(contextWithFD(ctx, fd), opcode, flags, fd, addr, len(p))
}
...
func (ur *ioUring) readWithBufferSelect(ctx context.Context, flags uint8, fd int, n int, group uint16) error {
	...
	return ur.submit9(contextWithFD(ctx, fd), opcode, flags, fd, 0, 0, n, 0, group, 0, 0)
}
...
func (ur *ioUring) write(ctx context.Context, flags uint8, fd int, p []byte, n int) error {
	...
	return ur.submit3(contextWithFD(ctx, fd), opcode, flags, fd, addr, n)
}

func (ur *ioUring) fadvise(ctx context.Context, flags uint8, fd int, offset int64, n int, advice int) error {
	return ur.submit6(contextWithFD(ctx, fd), IORING_OP_FADVISE, flags, fd, uint64(offset), 0, n, uint32(advice))
}
...
func (ur *ioUring) madvise(ctx context.Context, flags uint8, b []byte, advice int) error {
	...
	return ur.submit6(ctx, IORING_OP_MADVISE, flags, 0, 0, addr, len(b), uint32(advice))
}
...
func (ur *ioUring) receive(ctx context.Context, flags uint8, fd int, p []byte) error {
	if p == nil || len(p) < 1 {
		return ErrInvalidParam
	}
	...
	return ur.submit6(contextWithFD(ctx, fd), opcode, flags, fd, 0, addr, len(p), unix.MSG_WAITALL)
}

func (ur *ioUring) receiveWithBufferSelect(ctx context.Context, flags uint8, fd int, n int, group uint16) error {
	opcode := IORING_OP_RECV
	flags |= IOSQE_BUFFER_SELECT
...
func (ur *ioUring) openAt2(ctx context.Context, flags uint8, dirfd int, pathname string, how *unix.OpenHow) error {
	...
	return ur.submit6(contextWithFD(ctx, dirfd), IORING_OP_OPENAT2, flags, dirfd, off, addr, unix.SizeofOpenHow, 0)
}
...
func (ur *ioUring) epollCtl(ctx context.Context, flags uint8, epfd int, op int, fd int, events uint32) error {
	...
	return ur.submit6(contextWithFD(ctx, epfd), flags, opcode, epfd, uint64(fd), addr, op, 0)
}

func (ur *ioUring) epollAdd(ctx context.Context, epfd int, fd int, events uint32) error {
	return ur.epollCtl(contextWithFD(ctx, epfd), 0, epfd, unix.EPOLL_CTL_ADD, fd, events)
}

func (ur *ioUring) epollMod(ctx context.Context, epfd int, fd int, events uint32) error {
	return ur.epollCtl(contextWithFD(ctx, epfd), 0, epfd, unix.EPOLL_CTL_MOD, fd, events)
}

func (ur *ioUring) epollDel(ctx context.Context, epfd int, fd int) error {
	return ur.epollCtl(contextWithFD(ctx, epfd), 0, epfd, unix.EPOLL_CTL_DEL, fd, 0)
}
...
func (ur *ioUring) splice(ctx context.Context, flags uint8, rfd int, rOff *int64, wfd int, wOff *int64, n int, uflags int) error {
	...
	return ur.submit9(contextWithFD(ctx, wfd), IORING_OP_SPLICE, flags, wfd, wOffVal, rOffVal, n, uint32(uflags), 0, 0, rfd)
}
...
func (ur *ioUring) provideBuffers(ctx context.Context, flags uint8, num int, starting int, addr unsafe.Pointer, size int, group uint16) error {
	return ur.submit9(ctx, IORING_OP_PROVIDE_BUFFERS, flags, num, uint64(starting), uint64(uintptr(addr)), size, 0, group, 0, 0)
}

func (ur *ioUring) removeBuffers(ctx context.Context, flags uint8, num int, group uint16) error {
	return ur.submit9(ctx, IORING_OP_REMOVE_BUFFERS, flags, num, 0, 0, 0, 0, group, 0, 0)
}

func (ur *ioUring) tee(ctx context.Context, flags uint8, rfd int, wfd int, n int, uflags int) error {
	return ur.submit9(contextWithFD(ctx, wfd), IORING_OP_TEE, flags, wfd, 0, 0, n, uint32(uflags), 0, 0, rfd)
}

func (ur *ioUring) shutdown(ctx context.Context, flags uint8, fd int, how int) error {
	return ur.submit3(contextWithFD(ctx, fd), IORING_OP_SHUTDOWN, flags, fd, 0, how)
}
...
func (ur *ioUring) renameAt(ctx context.Context, flags uint8, oldPath, newPath string, uflags int) error {
	...
	return ur.submit6(ctx, IORING_OP_RENAMEAT, flags, unix.AT_FDCWD, newAddr, oldAddr, unix.AT_FDCWD, uint32(uflags))
}
...
func (ur *ioUring) unlinkAt(ctx context.Context, flags uint8, dirfd int, pathname string, uflags int) error {
	...
	return ur.submit6(contextWithFD(ctx, dirfd), IORING_OP_UNLINKAT, flags, dirfd, 0, addr, 0, uint32(uflags))
}
...
func (ur *ioUring) mkdirAt(ctx context.Context, flags uint8, dirfd int, pathname string, uflags int, mode uint32) error {
	...
	return ur.submit6(contextWithFD(ctx, dirfd), IORING_OP_MKDIRAT, flags, dirfd, 0, addr, int(mode), uint32(uflags))
}
...
func (ur *ioUring) symlinkAt(ctx context.Context, flags uint8, oldPath string, newDirfd int, newPath string) error {
	...
	return ur.submit6(contextWithFD(ctx, newDirfd), IORING_OP_SYMLINKAT, flags, newDirfd, newAddr, oldAddr, 0, 0)
}
...
func (ur *ioUring) linkAt(ctx context.Context, flags uint8, oldDirfd int, oldPath string, newDirfd int, newPath string, uflags int) error {
	...
	return ur.submit6(contextWithFD(ctx, newDirfd), IORING_OP_LINKAT, flags, oldDirfd, newAddr, oldAddr, newDirfd, uint32(uflags))
}

func (ur *ioUring) msgRing(ctx context.Context, flags uint8, targetFd int, userData int64, res int32) error {
	return ur.submit6(contextWithFD(ctx, targetFd), IORING_OP_MSG_RING, flags, targetFd, uint64(userData), 0, int(res), 0)
}

func (ur *ioUring) socket(ctx context.Context, flags uint8, domain, typ, proto int, fileIndex uint32) error {
	return ur.submit9(ctx, IORING_OP_SOCKET, flags, domain, uint64(typ), 0, proto, 0, 0, 0, int(fileIndex))
}

func (ur *ioUring) sendZeroCopy(ctx context.Context, flags uint8, fd int, p []byte, msgFlags uint32) error {
	addr := uint64(uintptr(unsafe.Pointer(unsafe.SliceData(p))))
	return ur.submit6(contextWithFD(ctx, fd), IORING_OP_SEND_ZC, flags, fd, 0, addr, len(p), msgFlags)
}
...
func (ur *ioUring) sendToZeroCopy(ctx context.Context, flags uint8, target Sockaddr, p []byte, msgFlags uint32) error {
	...
	addr := uint64(uintptr(unsafe.Pointer(unsafe.SliceData(p))))
	return ur.submit9(ctx, IORING_OP_SEND_ZC, flags, 0, uint64(uintptr(addr2)), addr, len(p), msgFlags, 0, 0, addrLen<<16)
}
